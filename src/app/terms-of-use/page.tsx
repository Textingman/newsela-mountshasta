...
export const metadata: Metadata = {
  title: "Terms of Use | Mount Shasta Union School District",
  description: "Terms of Use for Mount Shasta Union School District",
};
        ...
        <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
          <section>
            ...
            <p className="leading-relaxed">
              By accessing and using the Mount Shasta Union School District website, you accept
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              graphics, logos, images, and software, is the property of Mount
              Shasta Union School District and is protected by applicable intellectual property
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              express or implied. Mount Shasta Union School District does not warrant that the
          ...
          <section>
            ...
            <p className="leading-relaxed">
              To the fullest extent permitted by law, Mount Shasta Union School District shall
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              Mount Shasta Union School District uses SMS (text message) communications
            ...
            <p className="leading-relaxed mb-3">
              By opting in to receive SMS messages from Mount Shasta Union School District, you
            ...
            <p className="leading-relaxed">
              ...
              handled solely by Mount Shasta Union School District.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              are provided for your convenience only. Mount Shasta Union School District has no
          ...
          <section>
            ...
            <div className="mt-3 text-gray-700">
              <p className="font-semibold">Mount Shasta Union School District</p>
              <p>595 E Alma St</p>
              <p>Mount Shasta, CA 96067</p>
              <p>
                Email:{" "}
                <a
                  href="mailto:support@msusd.org"
